...
class PersistentStateTest extends
  Spec with 
  ShouldMatchers with 
  BeforeAndAfterAll {  
  ...
  describe("Transactional persistent Active Object ") {
    ...
    it("map should rollback state for stateful server in case of failure") {
      ...
      stateful.getMapState("testShouldRollbackStateForStatefulServerInCaseOfFailure") 
        should equal("init")
    }
